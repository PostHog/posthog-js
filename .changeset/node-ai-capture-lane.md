...
The OTel exporter path now always redacts media — the removed `_INTERNAL_LLMA_MULTIMODAL` env var previously allowed passthrough there too, and per-exporter passthrough is a planned follow-up.
