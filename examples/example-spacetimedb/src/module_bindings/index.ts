...
import RequestFlagEvalReducer from "./request_flag_eval_reducer";
import SayHelloReducer from "./say_hello_reducer";
import SetFeatureFlagsReducer from "./set_feature_flags_reducer";
...
import FlagRequestRow from "./flag_request_table";
...
const tablesSchema = __schema({
  featureFlag: __table({
    name: 'feature_flag',
    indexes: [
      { accessor: 'distinctId', name: 'feature_flag_distinct_id_idx_btree', algorithm: 'btree', columns: [
        'distinctId',
      ] },
    ],
    constraints: [
      { name: 'feature_flag_distinct_id_key', constraint: 'unique', columns: ['distinctId'] },
    ],
  }, FeatureFlagRow),
  flagRequest: __table({
    name: 'flag_request',
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("request_flag_eval", RequestFlagEvalReducer),
  __reducerSchema("say_hello", SayHelloReducer),
  __reducerSchema("set_feature_flags", SetFeatureFlagsReducer),
);
