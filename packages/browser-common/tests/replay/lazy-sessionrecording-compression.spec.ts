...
import type { ReplayRecorderClient } from '../../src/replay/host'
...
async function setupLazyLoadedSessionRecording({ gzipSupported, gzipCompress }: SetupOptions) {
    ...
    const [
        ...
        import('../../src/replay/external/lazy-loaded-session-recorder'),
        import('../../src/replay/globals'),
        import('../helpers/test-client'),
        import('../../src/disposable'),
        import('../../src/replay/constants'),
    ])
