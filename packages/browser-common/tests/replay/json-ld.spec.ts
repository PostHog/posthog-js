...
import { sanitizeJsonLd, startJsonLdCapture } from '../../src/replay/external/json-ld'
import jsonLdContract from '../../../browser/test-fixtures/json-ld-sanitization-v1.json'
