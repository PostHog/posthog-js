...
import { AndTriggerMatching, OrTriggerMatching } from '../../src/replay/external/triggerMatching'
import { FULL_SNAPSHOT_EVENT_TYPE, META_EVENT_TYPE } from '../../src/replay/external/sessionrecording-utils'
import { RECORDING_REMOTE_CONFIG_TTL_MS, SESSION_RECORDING_REMOTE_CONFIG } from '../../src/replay/constants'
import type { RemoteConfig, SessionRecordingPersistedConfig } from '../../src/replay/types'
import type { RemoteConfigResult } from '../../src/index'
import type { eventWithTime, fullSnapshotEvent, metaEvent } from '../../src/replay/rrweb-types'
