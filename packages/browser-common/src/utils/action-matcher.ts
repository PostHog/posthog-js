...
import type { ActionStepType, PropertyFilters, SurveyActionType, SurveyElement } from '../types'
import { SimpleEventEmitter } from './simple-event-emitter'
import type { CaptureResult, PropertyMatchType } from '../types'
import { isArray, isUndefined } from '@posthog/core'
import { matchPropertyFilters } from './property-utils'
import { extractTexts, extractHref, matchString, matchTexts } from './elements-chain-utils'
