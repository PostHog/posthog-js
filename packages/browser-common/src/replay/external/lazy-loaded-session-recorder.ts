...
export class LazyLoadedSessionRecording implements LazyLoadedSessionRecordingInterface {
    ...
    private _onSessionIdListener: import('../../index').Disposable | undefined = undefined
    private _onSessionIdleResetForcedListener: import('../../index').Disposable | undefined = undefined
    private _forceIdleSessionIdListener: import('../../index').Disposable | undefined = undefined
