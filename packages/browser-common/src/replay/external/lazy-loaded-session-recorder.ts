...
import type { SnapshotCost } from '../rrweb-types'
import {
    type customEvent,
    EventType,
    type eventWithTime,
...
export class LazyLoadedSessionRecording implements LazyLoadedSessionRecordingInterface {
    ...
    private _removePageViewCaptureHook: import('../../disposable').Disposable | undefined = undefined
    ...
    private _onSessionIdListener: import('../../disposable').Disposable | undefined = undefined
    private _onSessionIdleResetForcedListener: import('../../disposable').Disposable | undefined = undefined
    private _forceIdleSessionIdListener: import('../../disposable').Disposable | undefined = undefined
