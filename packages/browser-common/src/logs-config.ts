...
export interface BrowserLogsConfig extends LogCaptureOptions {
...
export function resolveLogsConfig(
    ...
    // Keep the explicit undefined fields supplied to core by the browser adapter.
