// oxlint-disable no-console -- Report generated bundles in this Node-only build configuration.
    ...
    return {
        ...
        async writeBundle(outputOptions, bundle) {
            for (const file of Object.values(bundle)) {
                const isJS = file.type === 'chunk' && (file.fileName.endsWith('.js') || file.fileName.endsWith('.cjs'))
...
export default defineConfig({
    ...
    plugins: [watchDeclarations(), umdPlugin({ name: 'rrwebSnapshot', outDir: 'dist' })],
})
