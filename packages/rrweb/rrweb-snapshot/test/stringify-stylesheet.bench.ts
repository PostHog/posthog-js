...
describe('stringifyStylesheet', () => {
    ...
    const cssText = fs.readFileSync(path.resolve(__dirname, './css/benchmark.css'), 'utf8')
    ...
    it.skip('stringify', () => {
        ...
        expect(stringifyStylesheet(styleSheet)).toEqual('x {background: url(https://example.com/relative.jpg);}')
    })
