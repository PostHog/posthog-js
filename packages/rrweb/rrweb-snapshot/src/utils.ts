...
export class Mirror implements IMirror<Node> {
    ...
    removeNodeFromMap(n: Node) {
        ...
        if ('shadowRoot' in n && (n as Element).shadowRoot) {
            this.removeNodeFromMap((n as Element).shadowRoot as unknown as Node)
        }

        if ('contentDocument' in n && (n as HTMLIFrameElement).contentDocument) {
