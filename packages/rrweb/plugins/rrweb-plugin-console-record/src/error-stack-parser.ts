...
export class StackFrame {
    ...
    constructor(obj: { fileName?: string; functionName?: string; lineNumber?: number; columnNumber?: number }) {
...
export const ErrorStackParser = {
    ...
    parseOpera: function (e: { stacktrace?: string; message: string; stack?: string }): StackFrame[] {
        if (
            !e.stacktrace ||
