...
export class BaseRRDocument extends BaseRRNode implements IRRDocument {
    ...
    public get documentElement(): IRRElement | null {
        return (
            (this.childNodes.find(
                (node) => node.RRNodeType === RRNodeType.Element && (node as IRRElement).tagName === 'HTML'
            ) as IRRElement) || null
        )
    }
    ...
    public get body(): IRRElement | null {
        return (
            (this.documentElement?.childNodes.find(
                (node) => node.RRNodeType === RRNodeType.Element && (node as IRRElement).tagName === 'BODY'
            ) as IRRElement) || null
        )
    }
    ...
    public get head(): IRRElement | null {
        return (
            (this.documentElement?.childNodes.find(
                (node) => node.RRNodeType === RRNodeType.Element && (node as IRRElement).tagName === 'HEAD'
            ) as IRRElement) || null
        )
    }
    ...
    public appendChild(newChild: IRRNode): IRRNode {
        ...
        if (nodeType === RRNodeType.Element || nodeType === RRNodeType.DocumentType) {
...
export class BaseRRElement extends BaseRRNode implements IRRElement {
    ...
    public get classList(): ClassList {
        return new ClassList(this.attributes.class as string | undefined, (newClassName) => {
    ...
    public get style() {
        const style = (this.attributes.style ? parseCSSText(this.attributes.style) : {}) as CSSStyleDeclaration
        const hyphenateRE = /\B([A-Z])/g
        style.setProperty = (name: string, value: string | null, priority?: string | null) => {
    ...
    public setAttributeNS(_namespace: string | null, qualifiedName: string, value: string): void {
...
function insertBefore(parent: IRRNode, newChild: IRRNode, refChild: IRRNode | null) {
