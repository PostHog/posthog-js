...
export type ImageBitmapDataURLWorkerParams = {
    ...
    width: number
    height: number
    // the canvas display size the encoded frame should be drawn back to on replay; carried
...
export type ImageBitmapDataURLWorkerMessage = ImageBitmapDataURLWorkerParams | ImageBitmapDataURLWorkerResetParams
...
export type GetTypedKeys<Obj extends object, ValueType> = TakeTypeHelper<Obj, ValueType>[keyof TakeTypeHelper<
    Obj,
    ValueType
>]
