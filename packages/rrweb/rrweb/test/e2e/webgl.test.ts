...
describe('e2e webgl', () => {
    ...
    it('will record and replay a webgl square', async () => {
        ...
        await page.setContent(getHtml.call(this, 'canvas-webgl-square.html', { recordCanvas: true }))

        await waitForRAF(page)

        const snapshots: eventWithTime[] = (await page.evaluate('window.snapshots')) as eventWithTime[]
    ...
    it('will record and replay a webgl image', async () => {
        ...
        await page.setContent(getHtml.call(this, 'canvas-webgl-image.html', { recordCanvas: true }))
