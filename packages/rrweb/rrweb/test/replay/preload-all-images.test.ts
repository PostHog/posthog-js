...
import { CanvasContext, CanvasArg, IncrementalSource, EventType, eventWithTime } from '@posthog/rrweb-types'
...
describe('preloadAllImages', () => {
    ...
    it('should preload image', () => {
        ...
        expect((replayer as any).imageMap.get('http://example.com')).toEqual(expectedImage)
    })
    ...
    it('should preload multiple images', () => {
        ...
        expect((replayer as any).imageMap.get('http://example.com/img1.png')).toEqual(expectedImage1)

        const expectedImage2 = new Image()
        expectedImage1.src = 'http://example.com/img2.png'

        expect((replayer as any).imageMap.get('http://example.com/img2.png')).toEqual(expectedImage1)
    })
})
