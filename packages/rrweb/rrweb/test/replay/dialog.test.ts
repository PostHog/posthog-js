...
import { fakeGoto, getServerURL, hideMouseAnimation, ISuite, launchPuppeteer, startServer, waitForRAF } from '../utils'
    ...
    ;[
        ...
        `)
          ...
          `)
                ...
                const defaultImageFilePrefix = 'dialog-test-ts-test-replay-dialog-test-ts-dialog'
                const kebabCaseName = name.replace(/ /g, '-').replace(/showModal/g, 'show-modal')
