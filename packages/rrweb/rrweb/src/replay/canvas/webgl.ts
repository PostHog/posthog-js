...
import { CanvasContext, type canvasMutationCommand } from '@posthog/rrweb-types'
...
function saveToWebGLVarMap(ctx: WebGLRenderingContext | WebGL2RenderingContext, result: any) {
