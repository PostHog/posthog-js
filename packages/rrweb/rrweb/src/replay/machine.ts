import { createMachine, interpret, assign, type StateMachine } from '@xstate/fsm'
import type { playerConfig } from '../types'
import { type eventWithTime, ReplayerEvents, EventType, type Emitter, IncrementalSource } from '@posthog/rrweb-types'
 ...
 */
export function discardPriorSnapshots(events: eventWithTime[], baselineTime: number): eventWithTime[] {
