...
export function findAndRemoveIframeBuffer(iframeEl: HTMLIFrameElement, knownDocs?: Set<Document>) {
...
type GroupingCSSRuleTypes =
    typeof CSSGroupingRule | typeof CSSMediaRule | typeof CSSSupportsRule | typeof CSSConditionRule
