...
import type { mutationCallBack, scrollCallback, SamplingStrategy } from '@posthog/rrweb-types'
import { initMutationObserver, initScrollObserver, initAdoptedStyleSheetObserver, mutationBuffers } from './observer'
...
export class ShadowDomManager {
    ...
    private patchAttachShadow(
        ...
        const manager = this
        this.restoreHandlers.push(
            patch(element.prototype, 'attachShadow', function (original: (init: ShadowRootInit) => ShadowRoot) {
