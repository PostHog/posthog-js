import { resetStylesheetLoadTracking, stringifyRule } from '@posthog/rrweb-snapshot'
import type {
    elementNode,
...
export class StylesheetManager {
    ...
    constructor(options: { mutationCb: mutationCallBack; adoptedStyleSheetCb: adoptedStyleSheetCallback }) {
