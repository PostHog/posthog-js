...
export const PostHogMCPAnalyticsProperty = {
  ...
  // Structured fields carried by the `collectFeedback` virtual tool's `$mcp_feedback` event.
  FeedbackType: '$mcp_feedback_type',
  FeedbackSentiment: '$mcp_sentiment',
  FeedbackCategory: '$mcp_category',
  FeedbackSummary: '$mcp_summary',
  FeedbackDetails: '$mcp_details',
  FeedbackProductArea: '$mcp_product_area',
  FeedbackSuggestedImprovement: '$mcp_suggested_improvement',
  FeedbackFrictionPoints: '$mcp_friction_points',
  FeedbackTaskCompleted: '$mcp_task_completed',
