...
export type PostHogSessionReplayConfig = {
  ...
  /**
   * Multiplier for the physical width and height of screenshots, clamped to 0.1–1.0.
   ...
   * Android only. Requires `@posthog/react-native-plugin` with Android SDK 3.63.0 or later.
  ...
  /**
   * WebP compression quality, clamped to 0–100. Fractional values are truncated.
  ...
  /**
   * Screenshot bitmap pixel format. ARGB_8888 preserves transparency and color precision.
