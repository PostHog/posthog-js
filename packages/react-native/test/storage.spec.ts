...
describe('PostHog React Native', () => {
  ...
  describe('storage', () => {
    ...
    it('waitForPersistSuccess surfaces a sync throw as false so callers can detect lost writes', async () => {
      // Without this, a sync-throwing storage pretends to succeed and callers that gate on
