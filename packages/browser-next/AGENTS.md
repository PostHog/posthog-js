...
Protect each core behavior with parity, Capture V1 compliance, conformance, or fault-injection tests. Run `pnpm bundle-size` after each runtime change and inspect module attribution when the graph changes.
