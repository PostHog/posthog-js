...
import { recordOptions } from '../extensions/replay/types/rrweb'
import {
...
// TODO can we move this out of main bundle?
import type { rrwebRecord as rrwebRecordType } from '../extensions/replay/types/rrweb'
import {
    type customEvent,
    EventType,
    eventWithTime,
...
export class LazyLoadedSessionRecording implements LazyLoadedSessionRecordingInterface {
    ...
    constructor(
        ...
        private readonly _config?: PostHogConfig
    ) {
