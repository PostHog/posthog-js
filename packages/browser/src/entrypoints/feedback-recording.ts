...
import { renderFeedbackRecordingUI } from '../extensions/feedback-recording/components/FeedbackRecordingUI'
import { removeFeedbackRecordingUIFromDOM } from '../extensions/feedback-recording/feedback-recording-utils'
...
class LazyLoadedFeedbackRecording implements LazyLoadedFeedbackRecordingInterface {
...
assignableWindow.__PosthogExtensions__.initFeedbackRecording = (ph) => new LazyLoadedFeedbackRecording(ph)

export default LazyLoadedFeedbackRecording
