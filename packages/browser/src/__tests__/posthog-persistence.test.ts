...
describe('posthog instance persistence', () => {
    ...
    it('should not write to storage if opt_out_persistence_by_default and opt_out_capturing_by_default is true', async () => {
    ...
    it('should write to storage if opt_out_persistence_by_default and opt_out_capturing_by_default is false', async () => {
        const sessionSpy = jest.spyOn(sessionStore, '_set')
        const localPlusCookieSpy = jest.spyOn(localPlusCookieStore, '_set')
