...
describe('logs entrypoint', () => {
    ...
    describe('module loading', () => {
        it('should initialize PostHog extensions when imported', async () => {
            ...
            expect(assignableWindow.__PosthogExtensions__.initializeLogs).toBeDefined()
            expect(typeof assignableWindow.__PosthogExtensions__.initializeLogs).toBe('function')
        })

        it('should preserve existing PostHog extensions', async () => {
            const existingExtension = jest.fn()
            assignableWindow.__PosthogExtensions__ = { initializeLogs: undefined } as any
    ...
    describe('initializeLogs function', () => {
        ...
        it('should be available as a PostHog extension', () => {
            const initializeLogs = assignableWindow.__PosthogExtensions__.initializeLogs
