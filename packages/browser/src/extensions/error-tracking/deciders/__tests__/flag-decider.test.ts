...
const createMockContext = (linkedFlag: string | null): { context: DeciderContext; triggerFlags: FlagCallback } => {
    ...
    const context: DeciderContext = {
        ...
        config: {
            errorTracking: {
                linked_feature_flag: linkedFlag,
            },
        } as RemoteConfig,
        log: jest.fn(),
    }
...
describe('FlagDecider', () => {
    const getDecider = (linkedFlag: string | null) => {
