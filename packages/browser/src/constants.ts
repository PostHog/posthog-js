...
export { SESSION_RECORDING_REMOTE_CONFIG } from './extensions/replay/constants'
export { RECORDING_REMOTE_CONFIG_TTL_MS } from './extensions/replay/constants'
...
// @deprecated can be removed along with eager loaded replay
export { SESSION_RECORDING_SAMPLE_RATE } from './extensions/replay/constants'
// @deprecated can be removed along with eager loaded replay
...
export { SESSION_RECORDING_OVERRIDE_SAMPLING } from './extensions/replay/constants'
export { SESSION_RECORDING_OVERRIDE_LINKED_FLAG } from './extensions/replay/constants'
export { SESSION_RECORDING_OVERRIDE_URL_TRIGGER } from './extensions/replay/constants'
export { SESSION_RECORDING_OVERRIDE_EVENT_TRIGGER } from './extensions/replay/constants'
export const SESSION_ID = '$sesid'
export { SESSION_RECORDING_IS_SAMPLED } from './extensions/replay/constants'
export { SESSION_RECORDING_PAST_MINIMUM_DURATION } from './extensions/replay/constants'
export { SESSION_RECORDING_URL_TRIGGER_ACTIVATED_SESSION } from './extensions/replay/constants'
export { SESSION_RECORDING_EVENT_TRIGGER_ACTIVATED_SESSION } from './extensions/replay/constants'
// V2 Trigger Groups: Per-group persistence key prefixes (suffix with group ID)
export { SESSION_RECORDING_TRIGGER_V2_GROUP_EVENT_PREFIX } from './extensions/replay/constants'
export { SESSION_RECORDING_TRIGGER_V2_GROUP_URL_PREFIX } from './extensions/replay/constants'
export { SESSION_RECORDING_TRIGGER_V2_GROUP_SAMPLING_PREFIX } from './extensions/replay/constants'
export { SESSION_RECORDING_FIRST_FULL_SNAPSHOT_TIMESTAMP } from './extensions/replay/constants'
export { SESSION_RECORDING_FLUSHED_SIZE } from './extensions/replay/constants'
...
export { SDK_DEBUG_RECORDING_SCRIPT_NOT_LOADED } from './extensions/replay/constants'
export { SDK_DEBUG_REPLAY_STALE_CONFIG } from './extensions/replay/constants'
export { SDK_DEBUG_REPLAY_EVENT_TRIGGER_STATUS } from './extensions/replay/constants'
export { SDK_DEBUG_REPLAY_LINKED_FLAG_TRIGGER_STATUS } from './extensions/replay/constants'
export { SDK_DEBUG_REPLAY_MATCHED_RECORDING_TRIGGER_GROUPS } from './extensions/replay/constants'
export { SDK_DEBUG_REPLAY_PENDING_TRIGGER_CONDITIONS } from './extensions/replay/constants'
export { SDK_DEBUG_REPLAY_REMOTE_TRIGGER_MATCHING_CONFIG } from './extensions/replay/constants'
export { SDK_DEBUG_REPLAY_TRIGGER_GROUPS_COUNT } from './extensions/replay/constants'
export { SDK_DEBUG_REPLAY_URL_TRIGGER_STATUS } from './extensions/replay/constants'
export { SDK_DEBUG_REPLAY_RRWEB_ATTACHED } from './extensions/replay/constants'
export { SDK_DEBUG_REPLAY_RRWEB_START_ATTEMPTED } from './extensions/replay/constants'
export { SESSION_RECORDING_START_REASON } from './extensions/replay/constants'
