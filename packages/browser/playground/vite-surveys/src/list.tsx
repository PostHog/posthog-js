...
const surveys = [
        ...
        questions: [
            {
                ...
                question: 'What would you pay for this product per month?',
                description: 'Drag the slider to your ideal price.',
                min: 0,
                max: 100,
                step: 5,
                prefix: '$',
                lowerBoundLabel: 'Free',
                upperBoundLabel: 'Premium',
            } as SliderSurveyQuestion,
        ],
        linked_flag_key: null,
        targeting_flag_key: null,
        appearance: {},
    ...
    },
    {
        ...
        questions: [
            {
                type: SurveyQuestionType.Slider,
                question: 'On a scale of 1–10, how much effort did this take?',
                description: '',
                min: 1,
                max: 10,
                step: 1,
                lowerBoundLabel: 'No effort',
                upperBoundLabel: 'A lot of effort',
            } as SliderSurveyQuestion,
        ],
        linked_flag_key: null,
        targeting_flag_key: null,
