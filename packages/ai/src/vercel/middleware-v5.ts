...
import type { LanguageModelV2, LanguageModelV2Middleware, LanguageModelV2StreamPart } from '@ai-sdk/provider'
...
const mapVercelPrompt = (messages: ModelMessage[]): PostHogInput[] => {
        ...
        if (c.type === 'text') {
          ...
          return {
            ...
            content: {
              ...
              mediaType: c.mediaType, // Updated for v5
            },
          }
        } else if (c.type === 'file') {
          return {
          ...
          return {
            ...
            content: {
              toolCallId: c.toolCallId,
              toolName: c.toolName,
              output: c.output, // Updated for v5
              isError: c.isError,
            },
          }
        }
    ...
    wrapGenerate: async ({ doGenerate, params }) => {
      ...
      try {
        ...
        await sendEventToPosthog({
          ...
          model: modelId,
          provider: provider,
          input: options.posthogPrivacyMode ? '' : mapVercelPrompt(params.messages),
