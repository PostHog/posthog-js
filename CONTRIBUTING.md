...
- **Already specified?** If a published [sdk-spec](https://github.com/PostHog/sdk-specs) defines the API, that's the agreement. Link the spec in your PR instead of opening an issue.
