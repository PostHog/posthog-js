...
for (const [scenario, node, harness, exit, message] of [
    ...
    ['unset-node', '', harnessImage, 2, 'NODE_IMAGE'],
    ['unset-harness', nodeImage, '', 2, 'HARNESS_IMAGE'],
    ['mutable-node', 'node:24-bookworm-slim', harnessImage, 2, 'NODE_IMAGE'],
    ['missing-repository', `@sha256:${digest}`, harnessImage, 2, 'NODE_IMAGE'],
    ['invalid-repository', `https://node@sha256:${digest}`, harnessImage, 2, 'NODE_IMAGE'],
    ['short-digest', 'node@sha256:abc', harnessImage, 2, 'NODE_IMAGE'],
    ['mutable-harness', nodeImage, 'ghcr.io/posthog/sdk-test-harness-v2:latest', 2, 'HARNESS_IMAGE'],
    ['wrong-harness', nodeImage, `ghcr.io/other/harness@sha256:${digest}`, 2, 'HARNESS_IMAGE'],
