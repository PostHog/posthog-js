...
| DLV-05 | CI    | Normal analytics flush uses Fetch and processes the complete V1 response before it removes or retries events.                                                                                        | Partial | Capture V1 sender tests; bounded queue pending        |
...
| DLV-07 | CI    | Request timeout, retry count, elapsed retry time, and backoff are bounded. Disposal cannot leave retry timers active.                                                                                | Partial | Retry count/backoff/disposal tests; timeout pending   |
