...
| INIT-08 | CI    | `dispose()` is idempotent, stops admission, removes listeners and timers, disposes extensions in reverse order, and drains lanes.                                                                            | Present | Extension, lifecycle, and public state-machine tests |
