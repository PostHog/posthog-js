...
| DLV-07 | CI    | Request timeout, retry count, elapsed retry time, and backoff are bounded. Disposal cannot leave retry timers active.                                                                                | Partial | Time budgets pass; active backoff cancellation pending |
