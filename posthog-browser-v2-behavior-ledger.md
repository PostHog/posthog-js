...
| V1-11 | DD    | Validation, authentication, billing, payload-size, media-type, and V1 rate-limit responses are terminal unless the canonical contract changes.                                | Partial | Capture V1 status matrix                                            |
