import { ensureMaxMessageSize, MutationRateLimiter, truncateLargeConsoleLogs } from './sessionrecording-utils'
import { PostHog } from '../posthog-core'
import { Properties, recordOptions, rrwebRecord } from '../types'
import type { eventWithTime, listenerHandler } from '@rrweb/types'
import { logger, _timestamp } from '../utils'
...
export class SessionRecording extends SessionRecordingPlaceholder {
    ...
    private rateLimiter?: MutationRateLimiter
    ...
    private get endpoint(): string {
        return this.decideResponse?.sessionRecording?.endpoint || BASE_ENDPOINT
    }
