...
describe('Autocapture system', () => {
    ...
    describe('_getPropertiesFromElement', () => {
        ...
        it('should contain the proper tag name', () => {
            const props = autocapture._domAutocapture['_getPropertiesFromElement'](div, false, false)
        ...
        it('should not collect input value', () => {
            const props = autocapture._domAutocapture['_getPropertiesFromElement'](input, false, false)
            expect(props['value']).toBeUndefined()
        })

        it('should strip element value with class "ph-sensitive"', () => {
            const props = autocapture._domAutocapture['_getPropertiesFromElement'](sensitiveInput, false, false)
            expect(props['value']).toBeUndefined()
        })

        it('should strip hidden element value', () => {
            const props = autocapture._domAutocapture['_getPropertiesFromElement'](hidden, false, false)
            expect(props['value']).toBeUndefined()
        })

        it('should strip password element value', () => {
            const props = autocapture._domAutocapture['_getPropertiesFromElement'](password, false, false)
            expect(props['value']).toBeUndefined()
        })
        ...
        it('should filter out Angular content attributes', () => {
            ...
            const props = autocapture._domAutocapture['_getPropertiesFromElement'](angularDiv, false, false)
    ...
    describe('_getAugmentPropertiesFromElement', () => {
        ...
        it('should collect multiple augments from elements', () => {
            const props = autocapture._domAutocapture['_getAugmentPropertiesFromElement'](div)
        ...
        it('should collect augment from input value', () => {
            const props = autocapture._domAutocapture['_getAugmentPropertiesFromElement'](input)
            expect(props['on-the-input']).toBe('is on the input')
        })

        it('should collect augment from input with class "ph-sensitive"', () => {
            const props = autocapture._domAutocapture['_getAugmentPropertiesFromElement'](sensitiveInput)
            expect(props['on-the-sensitive-input']).toBeUndefined()
        })

        it('should not collect augment from the hidden element value', () => {
            const props = autocapture._domAutocapture['_getAugmentPropertiesFromElement'](hidden)
            expect(props).toStrictEqual({})
        })

        it('should collect augment from the password element value', () => {
            const props = autocapture._domAutocapture['_getAugmentPropertiesFromElement'](password)
            expect(props).toStrictEqual({})
        })
    })
    ...
    describe('_previousElementSibling', () => {
        ...
        it('should return the adjacent sibling', () => {
            ...
            expect(autocapture._domAutocapture['_previousElementSibling'](child)).toBe(sibling)
        })
        ...
        it('should return null when the previous sibling is a text node', () => {
            ...
            div.appendChild(document.createTextNode('some text'))
            div.appendChild(child)
            expect(autocapture._domAutocapture['_previousElementSibling'](child)).toBeNull()
        })
    })
    ...
    describe('_getDefaultProperties', () => {
        it('should return the default properties', () => {
            ...
            expect(autocapture._domAutocapture['_getDefaultProperties']('test')).toEqual({
                $event_type: 'test',
                $ce_version: 1,
            })
        })
    ...
    describe('_captureEvent', () => {
        ...
        it('should capture rageclick', () => {
            ...
            autocapture._domAutocapture['_captureEvent'](fakeEvent)
            autocapture._domAutocapture['_captureEvent'](fakeEvent)
            autocapture._domAutocapture['_captureEvent'](fakeEvent)
        ...
        describe('clipboard autocapture', () => {
            ...
            it('should capture copy', () => {
                ...
                autocapture._domAutocapture['_captureEvent'](fakeEvent, '$copy_autocapture')
        ...
        it('includes necessary metadata as properties when capturing an event', () => {
            ...
            autocapture._domAutocapture['_captureEvent'](e)
            expect(captureMock).toHaveBeenCalledTimes(1)
        ...
        it('assigns element_selector if htmlelement matches known selectors', () => {
            ...
            elGrandparent.setAttribute('href', 'https://test.com')
            elGrandparent.appendChild(elParent)
            autocapture._domAutocapture['_captureEvent'](
                makeMouseEvent({
                    target: elTarget,
                })
            )
      ...
      `
            ...
            autocapture._domAutocapture['_captureEvent'](e1)
            ...
            captureMock.mockClear()
            autocapture._domAutocapture['_captureEvent'](e2)
            ...
            captureMock.mockClear()
            autocapture._domAutocapture['_captureEvent'](e3)
      ...
      `
        ...
        it('should never capture an element with `ph-no-capture` class', () => {
            ...
            a.appendChild(span)
            autocapture._domAutocapture['_captureEvent'](makeMouseEvent({ target: a }))
            expect(captureMock).toHaveBeenCalledTimes(1)

            autocapture._domAutocapture['_captureEvent'](makeMouseEvent({ target: span }))
      ...
      `
        ...
        it('returns elementsChain correctly with newlines in css', () => {
            ...
            autocapture._domAutocapture['_elementsChainAsString'] = true
            autocapture._domAutocapture['_captureEvent'](e)
            const props1 = captureMock.mock.calls[0][1].properties
