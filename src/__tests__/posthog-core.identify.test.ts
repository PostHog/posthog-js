...
describe('identify()', () => {
    ...
    describe('identify deduplication', () => {
        ...
        it('dedupes identical consecutive property updates with same identity', () => {
            instance.identify('new-user', { email: 'john@example.com' })
        ...
        it('does not dedupe when properties are different', () => {
            instance.identify('new-user', { email: 'john@example.com' })
            instance.identify('new-user', { email: 'john.doe@example.com' })
        ...
        it('does not dedupe when set_once properties are different', () => {
            instance.identify('new-user', { email: 'john@example.com' }, { first_seen: 'today' })
            instance.identify('new-user', { email: 'john@example.com' }, { first_seen: 'yesterday' })
        ...
        it('does not dedupe when properties are identical but in different order', () => {
            instance.identify('new-user', { name: 'John', email: 'john@example.com' })
            instance.identify('new-user', { email: 'john@example.com', name: 'John' })

            expect(beforeSendMock).toHaveBeenCalledTimes(2)
        })

        it('does not dedupe when identity changes', () => {
            instance.identify('user-1', { email: 'john@example.com' })
            instance.identify('user-2', { email: 'john@example.com' })
        ...
        it('dedupes when mixing identify and setPersonProperties with identical properties', () => {
            instance.identify('new-user', { email: 'john@example.com' })
            instance.setPersonProperties({ email: 'john@example.com' })
