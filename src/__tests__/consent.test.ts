...
describe('consentManager', () => {
    ...
    describe.each([
        ...
        `localStorage`,
        `localStorage+cookie`,
    ] as PostHogConfig['opt_out_capturing_persistence_type'][])(`%s`, (persistenceType) => {
        function assertPersistenceValue(value: string | number | null, persistencePrefix = DEFAULT_PERSISTENCE_PREFIX) {
